...
function themesflat_register_project_post_type() {
    ...
    $project_slug = themesflat_get_opt('project_slug', 'project');
    ...
    $labels = array(
        ...
        'not_found'             => esc_html__( 'No Project found', 'themesflat' ),

        'not_found_in_trash'    => esc_html__( 'No Project found in Trash', 'themesflat' )
