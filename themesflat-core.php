...
$theme = wp_get_theme();
if ( 'inverna' == $theme->name || 'inverna' == $theme->parent_theme ) {
...
final class ThemesFlat_Addon_For_Elementor_inverna {
    ...
    ========================================= */
        ...
        public static function get_template_id( $type ) {
            ...
            $tfhf_templates = ThemesFlat_Addon_For_Elementor_inverna::instance()->get_posts_by_conditions( 'tf_header_footer', $option );
...
ThemesFlat_Addon_For_Elementor_inverna::instance();
